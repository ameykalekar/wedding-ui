...
@Component({
  selector: 'app-partsproductmappping',
  templateUrl: './partsproductmappping.component.html',
  styleUrls: ['./partsproductmappping.component.css']
})
export class PartsproductmapppingComponent implements OnInit {
  ...
  constructor(private globalservice: GlobalserviceService,
    private partproductmappingservice: PartproductmappingService, private partservice: PartService,
  ...
  getChecklist(productid: string) {
    this.checklist = null;
    this.partproductmappingservice.getParts(productid).subscribe((res) => {
      ...
      if (res != null) {
        ...
        for (let index = 0; index < this.parts.length; index++) {
          ...
          this.existingtaskList.push({ value: element['id'], name: element['partName'] });
  ...
  onSubmit() {
    ...
    this.partproductmappingservice.save(partpoductmappings).subscribe(res => {
      console.log('Response' + res);
